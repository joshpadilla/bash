#Download the image First we download the cloud image from Ubuntu’s site. Thankfully Ubuntu provides ready-to-go images.

# cd /var/lib/libvirt/images
# wget https://cloud-images.ubuntu.com/trusty/current/trusty-server-cloudimg-amd64-disk1.img
# mv trusty-server-cloudimg-amd64-disk1.img trusty-server-cloudimg-amd64-disk1.img.dist
# qemu-img convert -O qcow2 trusty-server-cloudimg-amd64-disk1.img.dist trusty-server-cloudimg-amd64-disk1.img
# qemu-img resize trusty-server-cloudimg-amd64-disk1.img +8G

#mkdir -p /var/kvm/images # create a storage pool
#virt-install \
#name template \
#ram 2048 \
